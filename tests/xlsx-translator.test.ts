...
test("translates used shared and inline strings without changing workbook assets", async () => {
  ...
  zip.file("xl/worksheets/sheet1.xml", "<worksheet><sheetData><row><c r=\"A0\" s=\"1\"/><c r=\"A1\" t=\"s\"><v>0</v></c><c r=\"A2\" t=\"s\"><v>2</v></c><c r=\"A3\" t=\"inlineStr\"><is><t>注意安全 &amp; 防护</t></is></c></row></sheetData></worksheet>");
